    ...
    <footer id="footer" class="py-5 " style="background-color: #197163; position: relative;">
        ...
        <div class="container" style="padding-top: 10rem ">
            <div class="row text-light mt-5">
                <div class="col-lg-6">
                    <h5>&copy; Smart Kids School <script>document.write(new Date().getFullYear())</script>. All Rights Reserved. </h5>
                    <div class="mt-4">
                ...
                <div class="col-lg-3">
                  ...
                  <div class="mt-4">
                    <ul class="" style="padding:0; list-style:none;">
                      <li class="mb-0"><a href="{{ url('/staff') }}" class="text-light" style="text-decoration:none;">Staff & Dewan Guru</a></li>
                      <li class="mb-0"><a href="{{ url('/fasilitas') }}" class="text-light" style="text-decoration:none;">Fasilitas Sekolah</a></li>
                      <li class="mb-0"><a href="{{ url('/kegiatan') }}" class="text-light" style="text-decoration:none;">Kegiatan Sekolah</a></li>
                      <li class="mb-0"><a href="{{ url('/galeri') }}" class="text-light" style="text-decoration:none;">Galeri Sekolah</a></li>
                    </ul>
                  </div>
                </div>
