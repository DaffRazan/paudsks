            ...
            <div class="col-md-6">
                ...
                <div class="d-flex mt-5">
                    ...
                    <a target="_blank" href="https://wa.me/6282361143553" class="btn text-light"
                        style="flex-shrink: 0; background-color: #197163;">Kontak Kami</a>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row py-3">
            <div class="col-md col-sm text-center">
                <h1 class="font-weight-bold pb-3">Misi</h1>
                <div class="container ml-5" style="font-size:2vw;">
                    <h5 class="mt-3 text-small font-weight-light text-justify">1. Menciptakan suasana bermain yang
                        smart.</h5>
                    <h5 class="mt-3 text-small font-weight-light text-justify">2. Menanamkan cara belajar yang smart
                        kepada anak dengan mengusung konsep alam terbuka mengedepankan spiritual, sosial budaya, bahasa
                        dan teknologi.</h5>
                    <h5 class="mt-3 text-small font-weight-light text-justify">3. Mencetak generasi yang unggul sesuai
                        dengan bakat dan minat anak serta berakhlak mulia sejak usia dini.</h5>
                    <h5 class="mt-3 text-small font-weight-light text-justify">4. Memberikan pelayanan yang prima
    ...
    <div class="row my-5">
        <div class="col-lg-4">
            <div class="d-flex flex-column text-center">
                ...
                <p class="mx-auto" style="max-width: 75%">Sekolah dibangun dengan lingkungan yang banyak tumbuhan dan
                    bernuansa alam agar udara fresh.</p>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="d-flex flex-column text-center">
    ...
    <div class="row my-5">
        ...
        <div class="col-lg-4">
            <div class="d-flex flex-column text-center">
                ...
                <p class="mx-auto" style="max-width: 75%">Seluruh tenaga pengajar berkompeten dan berpengalaman di
                    bidangnya.</p>
            </div>
        </div>
    </div>
