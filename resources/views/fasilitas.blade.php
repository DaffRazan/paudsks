    ...
    <div class="row py-5">
        <div class="col-lg-6">
            <div class="text-center">
                <img class="img-thumbnail" height="400" width="400" src="{{ asset(Storage::url($item->gambar_fasilitas)) }}" alt="">
            </div>
        </div>
        <div class="col-lg-6">
    ...
    {{-- <div class="row py-5">
        <div class="col-lg-6">
            <div class="" style="padding-left: 70px;">
                ...
                <p class="font-weight-light">Ruang Belajar Kelompok Bermain dibangun dengan luas sehingga murid dapat
                    aktif dalam bermain sesama.</p>
            </div>
        </div>
        <div class="col-lg-6">
            <img class="img-thumbnail" height="400" width="400" src="{{ asset('uploads/fasilitas/kb.jpeg') }}"
                alt="Ruang Belajar">
        </div>
    </div> --}}
    @endforeach
